...
const getMyWatchesRef = (dc) => {
  const { dc: dcInstance} = validateArgs(connectorConfig, dc, undefined);
  dcInstance._useGeneratedSdk();
  return queryRef(dcInstance, 'GetMyWatches');
}
getMyWatchesRef.operationName = 'GetMyWatches';
exports.getMyWatchesRef = getMyWatchesRef;

exports.getMyWatches = function getMyWatches(dc) {
  return executeQuery(getMyWatchesRef(dc));
};
